...
int main(){
	...
	test_filter_gives_the_addresses_of_matched_elements_to_destination ();
	test_filter_returns_number_of_matches_found_for_isDivisible ();
	test_filter_stopes_when_max_size_of_destination_reaches_for_isDivisible();
	test_filter_gives_the_addresses_of_matched_elements_to_destination_for_isDivisible ();
